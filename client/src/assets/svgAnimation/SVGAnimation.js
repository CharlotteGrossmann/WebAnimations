...
function SVGAnimation() {
	/* var myElement = document.getElementById('svg-animation-svg');
	if (myElement) {
		...
		if (
			...
			document.getElementById('svg-letter-s').classList.add =
				'animate-letter-s';
			document.getElementById('svg-letter-v').classList.add =
				'animate-letter-v';
			document.getElementById('svg-ball').classList.add = 'ball';
			console.log('Element is in the viewport!');
		} else {
			document.getElementById('svg-letter-s').classList.remove =
				'animate-letter-s';
			document.getElementById('svg-letter-v').classList.remove =
				'animate-letter-v';
 ...
 */
	return (
		<div>
			...
			<div id='svg-ball' class='ball'></div>
		</div>
	);
}
