...
function TextBox({ title, textId, color }) {
	var dict = {
		...
		flashText:
			'1996 begann die Ära des Flash und damit auch der Web Animations Boom. Flash war ein von Macromedia entwickeltes Web Plugin, das zusammen mit Macromedia Flash, einem framebasierten Animationsprogramm, auf den Markt kam. Es hat die Entwicklung des Internets zu einem großen Teil vorangetrieben, da damit sehr einfach vektorbasierte Animationen, mit kleinen Datengrößen, erstellt werden konnten, welche überall auf einer Seite eingepflegt werden konnten. Allerdings brauchte man ein Browser Plugin, um die Flash Animationen abspielen zu können, während sie auf mobilen Geräten überhaupt nicht funktionierten. Spätestens als Steve Jobs 2010 bekannt gab Flash auf Apple Produkten nicht zu unterstützen, war die Ära des Flash zu Ende. 2020 wurde der Support auf allen Browsern endgültig eingestellt.',
